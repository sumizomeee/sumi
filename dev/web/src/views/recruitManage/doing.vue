 ...
 * @Last Modified time: 2019-12-27 21:04:34
 */
<template>
  <div id="recruitDoing">    
    ...
    <div class="moderBox">
      ...
      <el-dialog class="toSeeBox"
       ...
       <div>
          <span>职业:</span>{{toSeeTitle.job}}
       </div>
       <div>
         <span>简介:</span>{{toSeeTitle.description}}
       </div>
       <div>
         <span>福利:</span>{{toSeeTitle.welfare}}
       </div>
        <div>
         <span>工资:</span>{{toSeeTitle.salary}}
       </div>
       <div>
         <span>每天工作时间:</span>{{toSeeTitle.working_hours}}
       </div>
